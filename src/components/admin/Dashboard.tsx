    ...
    async function fetchData() {
      try {
        ...
        const [tickets, attended, avgTime, waitTime, absentTime] = await Promise.all([
          rootApi.get('/stats/tickets-per-counter', { params: { start_date: startDate, end_date: endDate, tenxa: 'xavixuyen' }, headers }),
          rootApi.get('/stats/attended-tickets', { params: { start_date: startDate, end_date: endDate, tenxa: 'xavixuyen' }, headers }),
          rootApi.get('/stats/average-handling-time', { params: { start_date: startDate, end_date: endDate, tenxa: 'xavixuyen' }, headers }),
          rootApi.get('/stats/average-waiting-time', { params: { start_date: startDate, end_date: endDate, tenxa: 'xavixuyen' }, headers }),
          rootApi.get('/stats/afk-duration', { params: { start_date: startDate, end_date: endDate, tenxa: 'xavixuyen' }, headers }),
        ]);
