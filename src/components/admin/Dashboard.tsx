    ...
    async function fetchData() {
      try {
        ...
        const [tickets, attended, avgTime, waitTime, absentTime, counters, ratingsRes, feedbacksRes] = await Promise.all([
          rootApi.get('/stats/tickets-per-counter', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
          rootApi.get('/stats/attended-tickets', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
          rootApi.get('/stats/average-handling-time', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
          rootApi.get('/stats/average-waiting-time', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
          rootApi.get('/stats/afk-duration', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
          rootApi.get('/counters', { params: { tenxa: 'xahoaan' }, headers }),
          // new endpoints
          rootApi.get('/stats/rating-per-counter', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
          rootApi.get('/stats/feedbacks', { params: { start_date: startStr, end_date: endStr, tenxa: 'xahoaan' }, headers }),
        ]);
