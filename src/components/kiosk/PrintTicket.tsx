    ...
    <div style="width:80mm;height:60mm;padding:4mm;font-family:'Arial', monospace;font-size:12px;line-height:1.4;text-align:center;display:flex;flex-direction:column;justify-content:space-between;">
      <div>
        <div style="font-weight:bold;font-size:14px;">
          TRUNG TÂM DỊCH VỤ HÀNH CHÍNH CÔNG<br>
          PHƯỜNG HÀ GIANG 1
        </div>
        ...
        <div style="margin-top:4px;font-weight: bold;">QUẦY PHỤC VỤ 0${counterId}</div>
      ...
      <div>
        ...
        <div style="font-style:italic;font-weight: bold;margin-top:8px;">
          Cảm ơn Quý khách!
        </div>
      </div>
    </div>
