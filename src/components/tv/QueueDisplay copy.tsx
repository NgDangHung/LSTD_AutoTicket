  ...
  useEffect(() => {
    ...
    const connectWebSocket = () => {
      try {
        ...
        console.log('🌐 WebSocket URL: wss://lstd.onrender.com/ws/updates/ws/updates');
        
        // ✅ REAL endpoint từ BE: wss://lstd.onrender.com/ws/updates/ws/updates
        ws = new WebSocket('wss://lstd.onrender.com/ws/updates/ws/updates');
        ...
        <div className="flex items-center gap-2" style={{marginLeft: '292px'}}>
          ...
          <div style={{ marginLeft: '30px', width: '60%' }}>
            <h1 className="text-4xl font-extrabold text-red-600 mb-4" style={{ lineHeight: '1.5' }}>
              TRUNG TÂM PHỤC VỤ HÀNH CHÍNH CÔNG PHƯỜNG HÀ GIANG 2 
            </h1>
